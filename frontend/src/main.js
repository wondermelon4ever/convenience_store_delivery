...
pluralCaseList.push( {plural: "invoices", pascal: "Invoice"} )

pluralCaseList.push( {plural: "parcels", pascal: "Parcel"} )

pluralCaseList.push( {plural: "deliveries", pascal: "Delivery"} )


pluralCaseList.push( {plural: "myParcels", pascal: "MyParcel"} )
